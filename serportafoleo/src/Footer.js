    ...
    return(
        <>
            <div className="container-fluid footer_bg" style={{"overflowX":"hidden"}}>
                ...
                <div className="row pb-4">
                    <div className="col-md-3 d-flex justify-content-around footer_social mx-auto ">
                        ...
                        <div> <a href="tel: +58 4124889099" target="_blank"><i title="Call" className="fa-solid fa-phone"></i></a> </div>
            ...
            <div className="contaier-fluid footer2_bg py-1" style={{"overflowX":"hidden"}}>
                <div className="row text-center"><h6 style={{"color": "#7b7f92"}}> Designed & Developed by Sergio Moncada <i className="fa-regular fa-hand-peace"></i>. </h6></div>
            </div>
